...
document.body.innerHTML += `Qual é o primeiro índice da letra <i>a</i> no seu nome? <strong>${nome.indexOf('a')}</strong><br />`;
document.body.innerHTML += `Qual é o último índice da letra <strong>a</strong> no seu nome? <strong>${nome.lastIndexOf('a')}</strong><br />`;
